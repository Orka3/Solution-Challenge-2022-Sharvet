...
class _Home1State extends State<HomePage1> {
  var randomNumber = Random().nextInt(1);
  List akf = ['Clean Earth is\nHappy Earth', 'A step for our next generation!'];
                                  ...
                                  child: Card(
                                      ...
                                      child: Container(
                                          ...
                                          child: Column(children: <Widget>[
                                            Image.asset('assets/image/rank.png',
                                                width: 100, height: 90),
                                            const SizedBox(height: 5),
                                            const Text('Green Rank',
                                                style: TextStyle(
                                                    fontFamily: 'font3',
                                                    fontSize: 20))
                                          ]))),
